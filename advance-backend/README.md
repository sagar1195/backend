...
- create `src/types/error.ts` for a custom error class
...
- register the error handler in `server.ts` **after all routes**
...
- throw errors anywhere in route handlers or async middleware
